...
~ current_plant_interaction = "plant_03"
...
=== chosen ===
~ to_plant_03 = true
Plantei uma muda de {plant_pot_03}.
-> ending
...
=== already_chose ===
Aqui está plantado um pé de {plant_pot_03}.
{plant_03_stage < 3:
    -> growing
  - else:
    -> will_you_store
...
Será que eu já guardo esta planta?
    ...
    + [Não.]
        Tudo bem.
        Este pé de {plant_pot_03} continuará aqui.
        -> ending
