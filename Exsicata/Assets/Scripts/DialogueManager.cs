...
public class DialogueManager : MonoBehaviour, IDataPersistence
{
    ...
    private void Start(){
        ...
        foreach(GameObject choice in choices){
            ...
            Debug.Log("Got choices' text game object correctly.");
            index++;
        }
    }
    ...
    private void Update(){
        ...
        if(canContinueToNextLine && PlayerInput.GetInstance().GetInteractPressed()){
            //continue story
            ContinueStory();
        }
    ...
    private void ContinueStory(){
        ...
        PlayerInput.GetInstance().playerController.StopPlayer();
