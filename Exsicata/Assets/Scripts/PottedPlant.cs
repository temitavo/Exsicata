...
public class PottedPlant : MonoBehaviour, IDataPersistence
{
    ...
    [SerializeField] private Color girassolColor = Color.white;
    [SerializeField] private Color lirioColor = Color.white;
    [SerializeField] private Color orquideaColor = Color.white;
    ...
    public Sprite[] girassolStages;
    public Sprite[] lirioStages;
    public Sprite[] orquideaStages;
    ...
    private void ChangePlantColor(string plantName){
        ...
        switch(plantName){
            case "":
                ...
                break;
            case "girassol":
                spriteRenderer.color = girassolColor;
                break;
            case "lírio":
                spriteRenderer.color = lirioColor;
                break;
            case "orquídea":
                spriteRenderer.color = orquideaColor;
                break;
            default:
    ...
    public void UpdatePlantStage(string plantName){
        ...
        switch(plantName){
            case "":
                ...
                break;
            case "girassol":
                plant.sprite = girassolStages[plantStage];
                break;
            case "lírio":
                plant.sprite = lirioStages[plantStage];
                break;
            case "orquídea":
                plant.sprite = orquideaStages[plantStage];
                break;
            default:
...
*/
                break;
            case "plant_pot_03":
                this.plantNameAtPlantPot = data.plantInPot03;
                this.plantStage = data.plantInPot03Stage;
                /*
                                if(!String.IsNullOrEmpty(data.timeStart03)){
                                    timerStart = DateTime.Parse(data.timeStart03);
                                    timerEnd = DateTime.Parse(data.timeEnd03);
                                }
                */
                break;
    ...
    public void SaveData(GameData data){
        ...
        switch(vaso){
            ...
            case "plant_pot_02":
                ...
                break;
            case "plant_pot_03":
                data.plantInPot03 = this.plantNameAtPlantPot;
                data.plantInPot03Stage = this.plantStage;

                data.timeStart03 = timerStart.ToString();
                data.timeEnd03 = timerEnd.ToString();
